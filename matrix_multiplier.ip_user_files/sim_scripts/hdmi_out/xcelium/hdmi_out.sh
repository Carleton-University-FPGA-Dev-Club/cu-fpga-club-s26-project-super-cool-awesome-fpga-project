...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname xlconstant_v1_1_8 -libname axi_lite_ipif_v3_0_4 -libname v_tc_v6_2_7 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib xlconstant_v1_1_8 axi_lite_ipif_v3_0_4 v_tc_v6_2_7)
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../matrix_multiplier.gen/sources_1/bd/hdmi_out/ipshared/c2c6" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../matrix_multiplier.gen/sources_1/bd/hdmi_out/ipshared/c2c6" \
  ...
  xmvlog -work xlconstant_v1_1_8 $xmvlog_opts +incdir+"../../../../matrix_multiplier.gen/sources_1/bd/hdmi_out/ipshared/c2c6" \
