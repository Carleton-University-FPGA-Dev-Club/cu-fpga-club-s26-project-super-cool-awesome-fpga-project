...
#
# Script generated by Vivado on Thu Aug 13 17:41:44 -0400 2026
...
design_libs=(xpm xil_defaultlib xlconstant_v1_1_8 axi_lite_ipif_v3_0_4 v_tc_v6_2_7)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../matrix_multiplier.gen/sources_1/bd/hdmi_out/ipshared/c2c6" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../matrix_multiplier.gen/sources_1/bd/hdmi_out/ipshared/c2c6" \
  ...
  vlogan -work xlconstant_v1_1_8 $vlogan_opts +v2k +incdir+"../../../../matrix_multiplier.gen/sources_1/bd/hdmi_out/ipshared/c2c6" \
...
reset_run()
{
  files_to_remove=(ucli.key hdmi_out_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc hdmi_out_simv.daidir vcs_lib c.obj)
