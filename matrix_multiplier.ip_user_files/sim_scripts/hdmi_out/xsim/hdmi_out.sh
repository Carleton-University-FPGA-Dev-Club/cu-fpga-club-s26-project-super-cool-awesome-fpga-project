...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_8 -L axi_lite_ipif_v3_0_4 -L v_tc_v6_2_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot hdmi_out xil_defaultlib.hdmi_out xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim hdmi_out -key {Behavioral:sim_1:Functional:hdmi_out} -tclbatch cmd.tcl -protoinst "protoinst_files/hdmi_out.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Home/vivado/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb hdmi_out.wdb xsim.dir libdpi.so)
