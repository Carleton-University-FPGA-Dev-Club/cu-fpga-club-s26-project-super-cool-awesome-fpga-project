...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hdmi_code is
  port (
    vid_out : out STD_LOGIC_VECTOR ( 6 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hdmi_code is
  ...
  signal \vid_out_reg[15]_i_3_n_0\ : STD_LOGIC;
  signal \vid_out_reg[15]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \vid_out_reg[20]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \vid_out_reg[20]_i_5\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \vid_out_reg[21]_i_3\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_13\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_15\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_16\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_17\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_19\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_21\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_7\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_9\ : label is "soft_lutpair6";
...
\vid_out_reg[11]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I3 => \vid_out_reg[23]_i_3_n_0\,
      I4 => \vid_out_reg[23]_i_4_n_0\,
...
\vid_out_reg[15]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \vid_out_reg[15]_i_4_n_0\,
      I5 => x_coordinate_reg(3),
      O => \vid_out_reg[15]_i_3_n_0\
    );
\vid_out_reg[15]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\vid_out_reg[20]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\vid_out_reg[21]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAAAB"
    )
        port map (
...
\vid_out_reg[21]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\vid_out_reg[23]_i_12\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\vid_out_reg[23]_i_15\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\vid_out_reg[23]_i_17\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\vid_out_reg[23]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"11101111"
    )
        port map (
...
\vid_out_reg[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000222"
        ...
        port map (
      I0 => \vid_out_reg[23]_i_5_n_0\,
      I1 => \vid_out_reg[20]_i_4_n_0\,
      I2 => x_coordinate_reg(9),
      I3 => x_coordinate_reg(8),
      I4 => x_coordinate_reg(10),
      I5 => \vid_out_reg[20]_i_2_n_0\,
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hdmi_code
     port map (
      ...
      vid_out(5) => \^vid_out\(5),
      vid_out(4 downto 3) => \^vid_out\(8 downto 7),
      vid_out(2) => \^vid_out\(14),
      vid_out(1) => \^vid_out\(1),
      vid_out(0) => \^vid_out\(9),
