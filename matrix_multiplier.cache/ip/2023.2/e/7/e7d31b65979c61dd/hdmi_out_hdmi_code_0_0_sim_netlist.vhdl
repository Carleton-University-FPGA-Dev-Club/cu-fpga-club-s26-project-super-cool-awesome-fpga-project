...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hdmi_code is
  ...
  signal \multiply2__19_carry__0_i_4_n_0\ : STD_LOGIC;
  ...
  signal \multiply2__19_carry_i_3_n_0\ : STD_LOGIC;
  signal \multiply2__19_carry_i_4_n_0\ : STD_LOGIC;
  signal \multiply2__19_carry_i_5_n_0\ : STD_LOGIC;
  signal \multiply2__19_carry_i_6_n_0\ : STD_LOGIC;
  signal \multiply2__19_carry_i_7_n_0\ : STD_LOGIC;
  signal \multiply2__19_carry_i_8_n_0\ : STD_LOGIC;
  ...
  signal multiply3 : STD_LOGIC_VECTOR ( 10 downto 1 );
  signal \multiply3__0\ : STD_LOGIC_VECTOR ( 11 downto 0 );
  ...
  signal \NLW_multiply2__19_carry_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_multiply2__19_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_multiply2__19_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \vid_out_reg[18]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_14\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_16\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_20\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_22\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_23\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_24\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \vid_out_reg[23]_i_9\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \x_coordinate[0]_i_6\ : label is "soft_lutpair3";
...
\multiply2__19_carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \multiply2__19_carry_i_1_n_0\,
      DI(2) => \multiply2__19_carry_i_2_n_0\,
      DI(1) => \multiply2__19_carry_i_3_n_0\,
      DI(0) => \multiply2__19_carry_i_4_n_0\,
      O(3 downto 0) => \NLW_multiply2__19_carry_O_UNCONNECTED\(3 downto 0),
      S(3) => \multiply2__19_carry_i_5_n_0\,
      S(2) => \multiply2__19_carry_i_6_n_0\,
      S(1) => \multiply2__19_carry_i_7_n_0\,
      S(0) => \multiply2__19_carry_i_8_n_0\
    );
\multiply2__19_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => \multiply2__19_carry_n_0\,
      CO(3 downto 2) => \NLW_multiply2__19_carry__0_CO_UNCONNECTED\(3 downto 2),
      CO(1) => multiply21_in,
      CO(0) => \multiply2__19_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => \multiply2__19_carry__0_i_1_n_0\,
      DI(0) => \multiply2__19_carry__0_i_2_n_0\,
      O(3 downto 0) => \NLW_multiply2__19_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3 downto 2) => B"00",
      S(1) => \multiply2__19_carry__0_i_3_n_0\,
      S(0) => \multiply2__19_carry__0_i_4_n_0\
    );
\multiply2__19_carry__0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
    )
        port map (
...
\multiply2__19_carry__0_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
    )
        port map (
...
\multiply2__19_carry__0_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
\multiply2__19_carry__0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I3 => multiply3(8),
      O => \multiply2__19_carry__0_i_4_n_0\
    );
\multiply2__19_carry_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
    )
        port map (
...
\multiply2__19_carry_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
    )
        port map (
...
\multiply2__19_carry_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
    )
        port map (
      ...
      O => \multiply2__19_carry_i_3_n_0\
    );
\multiply2__19_carry_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2B22"
    )
        port map (
      ...
      O => \multiply2__19_carry_i_4_n_0\
    );
\multiply2__19_carry_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I3 => multiply3(6),
      O => \multiply2__19_carry_i_5_n_0\
    );
\multiply2__19_carry_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I3 => multiply3(4),
      O => \multiply2__19_carry_i_6_n_0\
    );
\multiply2__19_carry_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I3 => multiply3(2),
      O => \multiply2__19_carry_i_7_n_0\
    );
\multiply2__19_carry_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
\multiply2_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 2) => x_coordinate_reg(8 downto 7),
      S(1) => \multiply2_carry__0_i_1_n_0\,
...
multiply2_carry_i_3: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
multiply3_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(2) => '0',
      DI(1 downto 0) => x_coordinate_reg(2 downto 1),
      O(3 downto 0) => \multiply3__0\(4 downto 1),
...
\multiply3_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => x_coordinate_reg(7),
      DI(1) => '0',
      DI(0) => x_coordinate_reg(5),
      O(3 downto 0) => \multiply3__0\(8 downto 5),
      S(3) => x_coordinate_reg(8),
      S(2) => \multiply3_carry__0_i_1_n_0\,
      S(1) => x_coordinate_reg(6),
      S(0) => \multiply3_carry__0_i_2_n_0\
    );
...
\multiply3_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(1 downto 0) => \multiply3__0\(10 downto 9),
      S(3 downto 2) => B"01",
      S(1 downto 0) => x_coordinate_reg(10 downto 9)
    );
...
\vid_out_reg[23]_i_16\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00007FFF"
    )
        port map (
...
\vid_out_reg[23]_i_19\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\vid_out_reg[23]_i_23\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
