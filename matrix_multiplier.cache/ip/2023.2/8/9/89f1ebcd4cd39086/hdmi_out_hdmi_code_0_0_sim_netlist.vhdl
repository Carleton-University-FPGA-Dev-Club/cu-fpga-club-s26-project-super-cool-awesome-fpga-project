...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hdmi_code is
  ...
  signal y_coordinate_reg : STD_LOGIC_VECTOR ( 11 downto 1 );
  ...
  attribute SOFT_HLUTNM of \vid_out[0]_INST_0_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \vid_out[0]_INST_0_i_10\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \vid_out[0]_INST_0_i_15\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \vid_out[0]_INST_0_i_17\ : label is "soft_lutpair0";
...
\vid_out[0]_INST_0_i_14\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\vid_out[0]_INST_0_i_15\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\vid_out[0]_INST_0_i_17\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1F"
    )
        port map (
...
\vid_out[0]_INST_0_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \vid_out[0]_INST_0_i_8_n_0\,
      I2 => \vid_out[0]_INST_0_i_9_n_0\,
...
\vid_out[0]_INST_0_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFEFFFEFFFFFFFE"
        ...
        port map (
      I0 => \vid_out[0]_INST_0_i_13_n_0\,
      I1 => \vid_out[0]_INST_0_i_14_n_0\,
      I2 => \vid_out[0]_INST_0_i_15_n_0\,
...
\vid_out[0]_INST_0_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01FFFFFF"
    )
        port map (
...
\vid_out[0]_INST_0_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
