...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hdmi_code is
  ...
  signal number_2110_in : STD_LOGIC;
  ...
  signal \number_21_carry__0_i_6_n_1\ : STD_LOGIC;
  signal \number_21_carry__0_i_6_n_2\ : STD_LOGIC;
  signal \number_21_carry__0_i_6_n_3\ : STD_LOGIC;
  signal \number_21_carry__0_n_2\ : STD_LOGIC;
  signal \number_21_carry__0_n_3\ : STD_LOGIC;
  signal number_21_carry_i_10_n_0 : STD_LOGIC;
  signal number_21_carry_i_10_n_1 : STD_LOGIC;
  signal number_21_carry_i_10_n_2 : STD_LOGIC;
  signal number_21_carry_i_10_n_3 : STD_LOGIC;
  signal number_21_carry_i_11_n_0 : STD_LOGIC;
  signal number_21_carry_i_12_n_0 : STD_LOGIC;
  ...
  signal number_21_carry_i_9_n_0 : STD_LOGIC;
  signal number_21_carry_i_9_n_1 : STD_LOGIC;
  signal number_21_carry_i_9_n_2 : STD_LOGIC;
  signal number_21_carry_i_9_n_3 : STD_LOGIC;
  ...
  signal \number_22_carry__0_n_4\ : STD_LOGIC;
  signal \number_22_carry__0_n_5\ : STD_LOGIC;
  signal \number_22_carry__0_n_6\ : STD_LOGIC;
  signal \number_22_carry__0_n_7\ : STD_LOGIC;
  ...
  signal \number_22_carry__1_n_4\ : STD_LOGIC;
  signal \number_22_carry__1_n_5\ : STD_LOGIC;
  signal \number_22_carry__1_n_6\ : STD_LOGIC;
  signal \number_22_carry__1_n_7\ : STD_LOGIC;
  signal \number_22_carry__2_n_3\ : STD_LOGIC;
  signal \number_22_carry__2_n_7\ : STD_LOGIC;
  signal number_22_carry_i_1_n_0 : STD_LOGIC;
  signal number_22_carry_i_2_n_0 : STD_LOGIC;
  signal number_22_carry_i_3_n_0 : STD_LOGIC;
  ...
  signal number_22_carry_n_4 : STD_LOGIC;
  signal number_22_carry_n_5 : STD_LOGIC;
  signal number_22_carry_n_6 : STD_LOGIC;
  ...
  signal \x_coordinate_reg[11]_i_4_n_3\ : STD_LOGIC;
  ...
  signal \NLW_number_21_carry__0_i_7_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_number_21_carry__0_i_7_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal NLW_number_21_carry_i_10_O_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_number_22_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \NLW_number_22_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_number_22_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_x_coordinate_reg[11]_i_4_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_x_coordinate_reg[11]_i_4_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute SOFT_HLUTNM of \vid_out[0]_INST_0_i_13\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \vid_out[0]_INST_0_i_15\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \vid_out[0]_INST_0_i_16\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \x_coordinate[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \x_coordinate[10]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \x_coordinate[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \x_coordinate[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \x_coordinate[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \x_coordinate[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \x_coordinate[5]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \x_coordinate[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \x_coordinate[7]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \x_coordinate[8]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \x_coordinate[9]_i_1\ : label is "soft_lutpair5";
...
\number_21_carry__0_i_6\: unisim.vcomponents.CARRY4
     port map (
      CI => number_21_carry_i_9_n_0,
      CO(3) => \number_21_carry__0_i_6_n_0\,
      CO(2) => \number_21_carry__0_i_6_n_1\,
      CO(1) => \number_21_carry__0_i_6_n_2\,
      CO(0) => \number_21_carry__0_i_6_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => number_22(11 downto 8),
      S(3 downto 0) => x_coordinate(10 downto 7)
    );
\number_21_carry__0_i_7\: unisim.vcomponents.CARRY4
     port map (
      CI => \number_21_carry__0_i_6_n_0\,
      CO(3 downto 2) => \NLW_number_21_carry__0_i_7_CO_UNCONNECTED\(3 downto 2),
      CO(1) => number_22(13),
      CO(0) => \NLW_number_21_carry__0_i_7_CO_UNCONNECTED\(0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_number_21_carry__0_i_7_O_UNCONNECTED\(3 downto 1),
      O(0) => number_22(12),
      S(3 downto 1) => B"001",
      S(0) => x_coordinate(11)
    );
...
number_21_carry_i_10: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => number_21_carry_i_10_n_0,
      CO(2) => number_21_carry_i_10_n_1,
      CO(1) => number_21_carry_i_10_n_2,
      CO(0) => number_21_carry_i_10_n_3,
      CYINIT => '0',
      DI(3) => x_coordinate(2),
      DI(2) => '0',
      DI(1) => x_coordinate(0),
      ...
      O(0) => NLW_number_21_carry_i_10_O_UNCONNECTED(0),
      S(3) => number_21_carry_i_11_n_0,
      S(2) => x_coordinate(1),
      S(1) => number_21_carry_i_12_n_0,
      S(0) => '0'
    );
number_21_carry_i_11: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => x_coordinate(2),
      O => number_21_carry_i_11_n_0
    );
number_21_carry_i_12: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => x_coordinate(0),
      O => number_21_carry_i_12_n_0
    );
...
number_21_carry_i_9: unisim.vcomponents.CARRY4
     port map (
      CI => number_21_carry_i_10_n_0,
      CO(3) => number_21_carry_i_9_n_0,
      CO(2) => number_21_carry_i_9_n_1,
      CO(1) => number_21_carry_i_9_n_2,
      CO(0) => number_21_carry_i_9_n_3,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
number_22_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => x_coordinate(2 downto 0),
      DI(0) => '0',
      O(3) => number_22_carry_n_4,
      O(2) => number_22_carry_n_5,
      O(1) => number_22_carry_n_6,
      O(0) => NLW_number_22_carry_O_UNCONNECTED(0),
      S(3) => number_22_carry_i_1_n_0,
      S(2) => number_22_carry_i_2_n_0,
      S(1) => number_22_carry_i_3_n_0,
      S(0) => '1'
    );
...
\number_22_carry__2\: unisim.vcomponents.CARRY4
     port map (
      CI => \number_22_carry__1_n_0\,
      CO(3 downto 1) => \NLW_number_22_carry__2_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \number_22_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_number_22_carry__2_O_UNCONNECTED\(3 downto 2),
      O(1) => p_0_in(13),
      O(0) => \number_22_carry__2_n_7\,
      S(3 downto 1) => B"001",
      S(0) => x_coordinate(11)
...
number_22_carry_i_3: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => x_coordinate(0),
      O => number_22_carry_i_3_n_0
    );
\vid_out[0]_INST_0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000AEAA00000000"
    )
        port map (
...
\vid_out[0]_INST_0_i_10\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\vid_out[0]_INST_0_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FDFF"
    )
        port map (
...
\vid_out[0]_INST_0_i_14\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0026"
    )
        port map (
...
\vid_out[0]_INST_0_i_16\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\vid_out[0]_INST_0_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000040400F0F4F40"
    )
        port map (
      I0 => x_coordinate_reg(1),
      I1 => \vid_out[0]_INST_0_i_11_n_0\,
      I2 => x_coordinate_reg(7),
      I3 => \vid_out[0]_INST_0_i_12_n_0\,
      I4 => x_coordinate_reg(4),
...
\vid_out[0]_INST_0_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00001F5500005040"
    )
        port map (
      I0 => y_coordinate_reg(5),
      I1 => \vid_out[0]_INST_0_i_16_n_0\,
      I2 => x_coordinate_reg(3),
      I3 => x_coordinate_reg(2),
      I4 => \vid_out[0]_INST_0_i_13_n_0\,
...
\x_coordinate[11]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\x_coordinate_reg[11]_i_4\: unisim.vcomponents.CARRY4
     port map (
      CI => \x_coordinate_reg[8]_i_2_n_0\,
      CO(3) => \NLW_x_coordinate_reg[11]_i_4_CO_UNCONNECTED\(3),
      CO(2) => data0(11),
      CO(1) => \NLW_x_coordinate_reg[11]_i_4_CO_UNCONNECTED\(1),
      CO(0) => \x_coordinate_reg[11]_i_4_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_x_coordinate_reg[11]_i_4_O_UNCONNECTED\(3 downto 2),
